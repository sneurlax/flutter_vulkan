...
/// RGBA8 pixel data + optional wgpu texture/view/sampler.
pub struct Sampler2D {
    ...
    // wgpu resources (created by create_wgpu_texture)
...
impl Sampler2D {
    ...
    /// Replace pixel data. No-op if n_texture hasn't been assigned.
    ...
    /// Create a wgpu texture from the stored pixel data (single mip, linear filter).
